/*
 * $Id: CompoundPainter.java 2103 2008-01-09 17:40:22Z headw01 $
 *
...
public class CompoundPainter<T> extends AbstractPainter<T> {
    ...
    private boolean checkForDirtyChildPainters = false;
     ...
     * @see #isDirty()
     */
    public boolean isCheckForDirtyChildPainters() {
     ...
     *
     * @see #isCheckForDirtyChildPainters()
     * @see #isDirty()
     */
    public void setCheckForDirtyChildPainters(boolean b) {
    ...
    protected boolean isDirty() {
        ...
        else if (isCheckForDirtyChildPainters()) {
            for (Painter p : painters) {
                if (p instanceof AbstractPainter) {
                    AbstractPainter ap = (AbstractPainter)p;
                    if (ap.isDirty()) {
