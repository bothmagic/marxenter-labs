/*
 * $Id: JXBusyLabel.java 2200 2008-02-06 21:43:36Z headw01 $
 *
...
public class JXBusyLabel extends JLabel {
    ...
    protected void initPainter(Dimension dim) {
        ...
        icon.setPainter(getBusyPainter());
        this.setPreferredSize(dim);
        this.setIcon(icon);
    }
    /**
     * Create and return an painter to use for the Label. This may be overridden
     * to return any painter you like.  By default, this method uses the UI
     * to create a BusyPainter.
