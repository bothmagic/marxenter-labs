/*
 * $Id: Searchable.java 2230 2008-02-13 05:24:09Z headw01 $
 *
 ...
 * @author Ramesh Gupta
 */
public interface Searchable<T extends SearchAssistant> {

    void setSearchAssistant(T searchAssistant);
    T getSearchAssistant();
