/*
 * $Id: SelectionMapper.java 1050 2007-01-26 11:11:44Z ovisvana $
 *
 ...
 */
package com.exalto.org.jdesktop.swingx.decorator;
 ...
 */
public class SelectionMapper implements PipelineListener {

    /** selection in view coordinates. */
    private ListSelectionModel viewSelection;
    
    /** selection in model coordinates. */
    protected TigerDefaultListSelectionModel modelSelection;
    ...
    public SelectionMapper(FilterPipeline pipeline, ListSelectionModel selection) {
        modelSelection = new TigerDefaultListSelectionModel();
...
//            modelSelection.clearSelection();
    ...
    public void restoreSelection() {
        ...
        if (viewSelection instanceof TigerDefaultListSelectionModel) {
            ((TigerDefaultListSelectionModel) viewSelection).moveLeadSelectionIndex(lead);
        } else {
