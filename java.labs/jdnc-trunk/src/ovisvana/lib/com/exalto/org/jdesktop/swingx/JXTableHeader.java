/*
 * $Id: JXTableHeader.java 1049 2007-01-26 11:09:04Z ovisvana $
 *
...
import com.exalto.org.jdesktop.swingx.event.TableColumnModelExtListener;
import com.exalto.org.jdesktop.swingx.table.ColumnHeaderRenderer;
...
//        setColumnModel(table.getColumnModel());
    ...
    private class HeaderListener implements MouseInputListener {
        ...
        private boolean shouldIgnore(MouseEvent e) {
        	...
        	System.out.println(" in shouldIgnore ret  " + (!SwingUtilities.isLeftMouseButton(e)
              || !table.isEnabled()));    	
        ...
        private void doSort(MouseEvent e) {
            ...
            if (!table.isSortable()) {
                System.out.println(" in doSort table not sortable ");    	
                return;
            }
            if (getSortGestureRecognizer().isResetSortOrderGesture(e)) {
            	
                System.out.println(" in doSort reset ");    	
	
                table.resetSortOrder();
                repaint();
            } else if (getSortGestureRecognizer().isToggleSortOrderGesture(e)){
            	
        System.out.println(" in doSort else if ");    	
