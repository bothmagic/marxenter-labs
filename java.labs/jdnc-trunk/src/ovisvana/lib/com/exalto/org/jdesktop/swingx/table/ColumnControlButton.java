/*
 * $Id: ColumnControlButton.java 1050 2007-01-26 11:11:44Z ovisvana $
 *
...
package com.exalto.org.jdesktop.swingx.table;
...
import com.exalto.org.jdesktop.swingx.JXTable;
...
public class ColumnControlButton extends JButton {
    ...
    private List columnVisibilityActions;
...
//                    .setVisible(e.getStateChange() == ItemEvent.SELECTED);
    ...
    public class DefaultControlPopup implements ControlPopup {
        ...
        public void addVisibilityActionItems(
                List actions) {
            addItems(new ArrayList(actions));
         ...
         * 
         */
        public void addAdditionalActionItems(List actions) {
            if (actions.size() == 0)
                return;
         ...
         * 
         */
        protected void addItems(List actions) {
...
//  ------------------------ updating the popupMenu
    ...
    protected void clearColumnVisibilityActions() {
        ...
        Iterator it = columnVisibilityActions.iterator();
        while(it.hasNext()) {
        	ColumnVisibilityAction action = (ColumnVisibilityAction) it.next();
     ...
     */
    protected List getColumnVisibilityActions() {
        if (columnVisibilityActions == null) {
