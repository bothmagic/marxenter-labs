/*
 * $Id: LookAndFeelAddons.java 1050 2007-01-26 11:11:44Z ovisvana $
 *
...
import com.exalto.org.jdesktop.swingx.plaf.metal.MetalLookAndFeelAddons;
 ...
 */
public class LookAndFeelAddons implements Addons {

  private static List contributedComponents =
    new ArrayList();
...
//OV  private static LookAndFeelAddons currentAddon;
  private static Addons currentAddon;
  ...
  public static void setAddon(Class addonClass) throws InstantiationException,
    IllegalAccessException {
  	System.out.println(" laf addon name = " + addonClass.getName());
  //  LookAndFeelAddons addon = (LookAndFeelAddons) addonClass.newInstance();
 //OV    Addons addon = (LookAndFeelAddons) addonClass.newInstance();
    Addons addon = (Addons) addonClass.newInstance();
    setAddon(addon);
  }
   
//  public static void setAddon(LookAndFeelAddons addon) {
  public static void setAddon(Addons addon) {
...
//OV  public static LookAndFeelAddons getAddon() {
  public static Addons getAddon() {
    return currentAddon;
  }
