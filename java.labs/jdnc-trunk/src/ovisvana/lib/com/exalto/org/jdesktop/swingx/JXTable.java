/*
 * $Id: JXTable.java 1049 2007-01-26 11:09:04Z ovisvana $
 *
...
import com.exalto.org.jdesktop.swingx.RolloverProducer;
import com.exalto.org.jdesktop.swingx.RolloverController;
...
import com.exalto.org.jdesktop.swingx.decorator.FilterPipeline;
import com.exalto.org.jdesktop.swingx.decorator.PipelineEvent;
import com.exalto.org.jdesktop.swingx.decorator.PipelineListener;
import com.exalto.org.jdesktop.swingx.decorator.ResetDTCRColorHighlighter;
import com.exalto.org.jdesktop.swingx.decorator.SelectionMapper;
import com.exalto.org.jdesktop.swingx.decorator.SizeSequenceMapper;
import com.exalto.org.jdesktop.swingx.decorator.SortController;
import com.exalto.org.jdesktop.swingx.decorator.SortKey;
import com.exalto.org.jdesktop.swingx.decorator.SortOrder;
import com.exalto.org.jdesktop.swingx.plaf.LookAndFeelAddons;
import com.exalto.org.jdesktop.swingx.table.ColumnControlButton;
import com.exalto.org.jdesktop.swingx.table.ColumnFactory;
import com.exalto.org.jdesktop.swingx.table.TableColumnExt;
import com.exalto.org.jdesktop.swingx.table.TableColumnModelExt;
import com.exalto.org.jdesktop.swingx.icon.ColumnControlIcon;
...
//    implements TableColumnModelExtListener 
    ...
    static {
        ...
        System.setProperty("swing.addon", "com.exalto.org.jdesktop.swingx.plaf.metal.MetalLookAndFeelAddons");
...
//        configureViewportBackground();
    ...
    //OV                scrollPane.setCorner(JScrollPane.UPPER_TRAILING_CORNER,
...
//--------------------- actions
     ...
     */
    private class Actions extends com.exalto.org.jdesktop.swingx.UIAction {
        Actions(String name) {
            super(name);
        }
...
//------------------------ override super because of filter-awareness
    ...
    public int getRowCount() {
        ...
        return (initialized)? filters == null ?
                super.getRowCount() : filters.getOutputSize() : 0;
    }
    ...
    public void setModel(TableModel newModel) {
    	...
    	System.out.println(" jxt setmodel");
...
//----------------------------- enhanced editing support
    ...
    public void setTerminateEditOnFocusLost(boolean terminate) {
        ...
        putClientProperty("terminateEditOnFocusLost", new Boolean(terminate));
    }
    ...
    public void setAutoStartEditOnKeyStroke(boolean autoStart) {
        ...
        putClientProperty("JTable.autoStartsEdit", new Boolean(autoStart));
