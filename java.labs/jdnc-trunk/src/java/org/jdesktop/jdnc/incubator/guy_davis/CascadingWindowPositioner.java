/**
 * $Id: CascadingWindowPositioner.java 810 2006-06-25 21:33:16Z guy_davis $
 *
 ...
 * from the upper left.  This class only sets the positions, the size is set by 
 * the window itself.
 * 
 * @author Guy Davis
 */
public class CascadingWindowPositioner implements WindowPositioner {
	...
	/**
	 * @see ca.guydavis.swing.desktop.WindowPositioner#getPosition(javax.swing.JInternalFrame, java.util.List)
	 */
	public Point getPosition(JInternalFrame newFrame,
		...
		outer: while (true) {
			inner: for (JInternalFrame frame : frames) {
