/*
 * $Id: BasicDatePickerFormatter.java 1774 2007-09-27 20:49:19Z kschaefe $
 * 
 ...
 */
public class BasicDatePickerFormatter extends
        JFormattedTextField.AbstractFormatter {
    
    private static final Logger LOG = Logger
            .getLogger(BasicDatePickerFormatter.class.getName());
     ...
     *
     */
    public BasicDatePickerFormatter() {
        this(null);
    }
     ...
     *   null formats.
     */
    public BasicDatePickerFormatter(DateFormat formats[]) {
        setFormats(formats);
    }
    ...
    public void setFormats(DateFormat...formats) {
        ...
        _formats = Contract.asNotNull(formats, "formats cannot contain null");
    }
