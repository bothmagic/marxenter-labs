 ...
 * @author Ramesh Gupta
 */
public class DefaultTreeTableModel_REDEN extends AbstractTreeTableModel_REDEN {

    protected boolean asksAllowsChildren;

    public DefaultTreeTableModel_REDEN() {
        this(null);
    }

    public DefaultTreeTableModel_REDEN(TreeNode root) {
        this(root, false);
    }

    public DefaultTreeTableModel_REDEN(TreeNode root, boolean asksAllowsChildren) {
        super(root);
