 ...
 * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN}. It extends the
 ...
 * {@link #setTreeTableModel(org.jdesktop.swingx.treetable.TreeTableModel_REDEN) setTreeTableModel}.
 ...
 * @author Ramesh Gupta
 */
public class JXTreeTable_REDEN extends JXTable {
	private static final Logger LOG = Logger.getLogger( JXTreeTable_REDEN.class
            .getName());
    /**
     ...
     */
    public JXTreeTable_REDEN() {
        this(new DefaultTreeTableModel_REDEN());
    }

    /**
     * Constructs a JXTreeTable using the specified
     * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN}.
     *
     * @param treeModel model for the JXTreeTable
     */
    public JXTreeTable_REDEN( TreeTableModel_REDEN treeModel) {
        // Implementation note:
        ...
        this(treeModel, new JXTreeTable_REDEN.TreeTableCellRenderer(treeModel));
    }

    /**
     * Constructs a <code>JXTreeTable</code> using the specified
     * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN} and
     * {@link org.jdesktop.swingx.JXTreeTable_REDEN.TreeTableCellRenderer}. The renderer
     * must have been constructed using the same instance of
     * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN} as passed to this
     * constructor.
     *
     * @param treeModel model for the JXTreeTable
     ...
     */
    private JXTreeTable_REDEN( TreeTableModel_REDEN treeModel, TreeTableCellRenderer renderer) {
...
//        expandOrCollapseNode(column, e);    // RG: Fix Issue 49!
    ...
    protected void processMouseEvent(MouseEvent e) {
		...
		if ( column >= 0 ) {
			boolean consume = expandOrCollapseNode(column, e);
			if (consume) {
				e.consume();
				return;
			}
     ...
     * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN}. The same data model
     * may be shared by any number of JXTreeTable instances.
     *
     * @param treeModel data model for this JXTreeTable
     */
    public void setTreeTableModel( TreeTableModel_REDEN treeModel) {
        TreeTableModel_REDEN old = getTreeTableModel();
     ...
     */
    public TreeTableModel_REDEN getTreeTableModel() {
     ...
     * {@link org.jdesktop.swingx.treetable.TreeTableModel_REDEN} to make it a compatible
     * TableModel, <b>this method should never be called directly</b>. Use
     * {@link #setTreeTableModel(org.jdesktop.swingx.treetable.TreeTableModel_REDEN) setTreeTableModel} instead.</p>
     *
...
//------------------------------ exposed tree listeners
    ...
    public void updateUI() {
        ...
        if (renderer != null) {
            ...
            // laf changes.
			initEditor(getTreeTableModel(), renderer);
    ...
    public boolean isHierarchical(int column) {
		return getTreeTableModel().getHierarchicalColumn() == column;
    }
    ...
    private void init(TreeTableCellRenderer renderer) {
		...
		java.util.List<TableColumn> column_list = getColumns(true);
		column_list.get(getTreeTableModel().getHierarchicalColumn()).setCellRenderer(
			renderer);
        ...
        PropertyChangeListener l = new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                JXTreeTable_REDEN.this.renderer.putClientProperty(evt.getPropertyName(), evt.getNewValue());
	...
	private void initEditor(TreeTableModel_REDEN model, TreeTableCellRenderer renderer) {
        // JW: change to re-use the editor!
		if ( getColumnCount( true ) > 0 ) {
			java.util.List<TableColumn> column_list = getColumns(true);
			column_list.get(model.getHierarchicalColumn()).setCellEditor(
    ...
    private static class TreeTableModelAdapter extends AbstractTableModel {
         ...
         */
        TreeTableModelAdapter( TreeTableModel_REDEN model, JTree tree) {
            assert model != null;
            assert tree != null;
         ...
         */
        public void setTreeTableModel( TreeTableModel_REDEN model) {
            TreeTableModel_REDEN old = getTreeTableModel();
            if (old != null) {
         ...
         * {@link org.jdesktop.swingx.JXTreeTable_REDEN#setModel(javax.swing.table.TableModel)}.
         *
         * @return JXTreeTable to which this TreeTableModelAdapter is permanently bound
         */
        protected JXTreeTable_REDEN getTreeTable() {
            return treeTable;
        }
         ...
         */
        protected final void bind( JXTreeTable_REDEN treeTable) {
        ...
        private TreeTableModel_REDEN model; // immutable
        private final JTree tree; // immutable
        private JXTreeTable_REDEN treeTable = null; // logically immutable
    }
    ...
    static class TreeTableCellRenderer extends JXTree implements
        ...
        public TreeTableCellRenderer( TreeTableModel_REDEN model) {
            super(model);
...
//                    p.x, p.y,
         ...
         */
        public final void bind( JXTreeTable_REDEN treeTable) {
            // Suppress potentially subversive invocation!
            // Prevent clearing out the deck for possible hijack attempt later!
            if (treeTable == null) {
                throw new IllegalArgumentException("null treeTable");
...
//            }
        ...
        protected JXTreeTable_REDEN treeTable = null;
    ...
    protected static class TreeTableDataAdapter extends JXTable.TableAdapter {
        private final JXTreeTable_REDEN table;
         ...
         */
        public TreeTableDataAdapter( JXTreeTable_REDEN component) {
            super(component);
            table = component;
        }
        public JXTreeTable_REDEN getTreeTable() {
            return table;
        }
