/*
 * $Id: JXDatePicker.java 1490 2007-07-09 22:15:35Z mzehnder $
 *
...
public class JXDatePicker extends JComponent {
     ...
     * if it is a subclass of <code>JXDatePickerFormatter<code> and 
     * furthermore implements the interface <code>IDatePickerFormats</code>.
    ...
    public DateFormat[] getFormats() {
        ...
        if (factory != null) {
            ...
            if (formatter instanceof IDatePickerFormats) {
                return ((IDatePickerFormats) formatter).getFormats();
            }
        }
        return null;
    }
