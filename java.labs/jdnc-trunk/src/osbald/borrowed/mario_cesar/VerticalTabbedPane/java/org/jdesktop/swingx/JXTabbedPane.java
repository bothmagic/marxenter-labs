...
/*
    *RJO* Added a client property "JXTabbedPane.defaultTabsCloseable" which can be used to control
    whether tabs added via the parents (JTabbedPane) methods are closeable or not.
 */
...
public class JXTabbedPane extends javax.swing.JTabbedPane implements Serializable {
    ...
    private boolean defaultTabsCloseable = true;
    ...
    public JXTabbedPane(int tabPlacement, int tabLayoutPolicy) {
        ...
        addPropertyChangeListener("JXTabbedPane.defaultTabsCloseable", new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                defaultTabsCloseable = Boolean.valueOf((Boolean)event.getNewValue());
            }
        });
    }
    /**
    ...
    public void insertTab(String title, Icon icon, Component component, String tip, int index) {
        CloseTabIcon ico = new CloseTabIcon(title, icon, isDefaultTabsCloseable());
        int newIndex = index;
    ...
    */
    ...
    boolean isDefaultTabsCloseable() {
        return defaultTabsCloseable;
    }
    ...
    protected class CloseTabIcon implements Icon {
