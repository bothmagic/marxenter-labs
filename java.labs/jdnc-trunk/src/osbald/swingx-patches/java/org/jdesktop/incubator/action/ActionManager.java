/*
 * $Id: ActionManager.java 2578 2008-07-29 23:16:17Z osbald $
 *
 ...
 * <p>
 *  <pre>
 *   ActionManager manager = SingletonActionManager.getInstance();
 *
 *   // load Actions
...
public class ActionManager extends ActionMap {
    ...
    private AbstractActionExt getStateChangeAction(Object id) {
        ...
        if (a != null && a instanceof AbstractActionExt) {
            AbstractActionExt actionExt = (AbstractActionExt)a;
     ...
     * action remain in sync with respect to their enabled state.
     *
     * @param id value of the action id
