/*
 * $Id: ColumnControlButton.java 3012 2009-02-04 15:13:47Z osbald $
 *
...
public class ColumnControlButton extends JButton {
    ...
    /* RJO: should be only difference with official SwingX version, access really useful to
    subclasses and awkward to keep your own copies due to constructor initialisation
    (ie populatePopup() called via super() - your copy wont be initialised in time). 
     */
