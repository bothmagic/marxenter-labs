/*
 * $Id: JVM.java 2578 2008-07-29 23:16:17Z osbald $
 *
...
/*
   ...
   04-Apr-2008 RJO: Added JDK1_7 to the pre-existing class otherwise it'd default to 1.3 under 7.0.
   Struck me growing these constants for every release is dull. So I created RuntimeVersion as a
   possible replacement? advice?
...
public class JVM {
    ...
    public boolean before(int p_Version) {
        return jdkVersion < p_Version;
    }
