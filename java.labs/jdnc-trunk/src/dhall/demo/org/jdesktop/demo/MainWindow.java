...
public class MainWindow extends javax.swing.JFrame {
    ...
    public void init(DemoPanel panel) {
        this.demo = panel;
...
// TODO add your handling code here:
    ...
    static public MainWindow showMainWindow(final DemoPanel panel) {
        final MainWindow mainWindow = new MainWindow();
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                mainWindow.init(panel);
                mainWindow.setTitle(panel.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MainWindow mainWindow = showMainWindow(demo);
        } catch (Exception e) {
