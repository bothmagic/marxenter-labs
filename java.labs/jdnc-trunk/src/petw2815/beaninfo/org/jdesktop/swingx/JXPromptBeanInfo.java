...
import org.jdesktop.swingx.PromptSupport.FocusBehavior;
	...
	protected void initialize() {
		...
		setEnumerationValues(new EnumerationValue[] {
				new EnumerationValue("Show", FocusBehavior.SHOW_PROMPT,
						"org.jdesktop.swingx.PromptSupport.FocusBehavior.SHOW_PROMPT"),
				new EnumerationValue("Hide", FocusBehavior.HIDE_PROMPT,
						"org.jdesktop.swingx.PromptSupport.FocusBehavior.HIDE_PROMPT"),
				new EnumerationValue("Highlight", FocusBehavior.HIGHLIGHT_PROMPT,
						"org.jdesktop.swingx.PromptSupport.FocusBehavior.HIGHLIGHT_PROMPT"), }, "focusBehavior");
	}
}
