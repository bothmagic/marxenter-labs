...
package org.jdesktop.swingx.jxmlnote.widgets;
...
import org.jdesktop.swingx.jxmlnote.clipboard.XMLNoteTransferHandler;
...
import org.jdesktop.swingx.jxmlnote.interfaces.UpdateViewListener;
import org.jdesktop.swingx.jxmlnote.toolbar.JXMLNoteToolBar;
import org.jdesktop.swingx.jxmlnote.undo.JXMLNotePaneCaretUndoableEdit;
...
public class JXMLNotePane extends JTextPane implements DocumentAdminListener, DocumentListener {
	...
	public boolean insertMark(String id,String _class) throws MarkExistsException, NoSelectionException,BadLocationException {
		...
		int len=end-offset;
		if (len<=0) { throw new NoSelectionException(); }
		return getXMLNoteDoc().insertMark(id, _class,offset,len);
	}
	 ...
	 * see {@link org.jdesktop.swingx.jxmlnote.document.XMLNoteDocument#getMarksForOffset(int) XMLNoteDocument.getMarksForOffset}. 
	 * @return
	 */
	 ...
	 * see {@link org.jdesktop.swingx.jxmlnote.document.XMLNoteDocument#getMarksForSelection(int,int) XMLNoteDocument.getMarksForSelection}.
	 ...
	 * 
	 * see {@link org.jdesktop.swingx.jxmlnote.document.XMLNoteDocment.getMarksContainedInSelection(int,in) XMLNoteDocument.getMarksContainedInSelection).
	 * 
	 * @throws NoSelectionException
	 * @return
	 */
