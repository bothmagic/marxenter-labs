 ...
 */
public class BasicXComboPopupScratch extends JPopupMenu implements ComboPopup {
...
//        comboBox.unregisterKeyboardAction( KeyStroke.getKeyStroke( KeyEvent.VK_ENTER, 0 ) );
    ...
    //
    public BasicXComboPopupScratch( JComboBox combo ) {
        super();
     ...
     *
     * @see BasicXComboPopupScratch#createMouseListener
     */
