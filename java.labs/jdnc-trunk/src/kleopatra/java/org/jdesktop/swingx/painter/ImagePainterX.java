/*
 * $Id: ImagePainterX.java 1193 2007-04-03 16:20:57Z kleopatra $
 *
 ...
 * @author Richard
 */
public class ImagePainterX<T> extends AbstractAreaPainterX<T> {
    /**
     * Logger to use
     */
    private static final Logger LOG = Logger.getLogger(ImagePainterX.class.getName());
     ...
     */
    public ImagePainterX(BufferedImage image) {
     ...
     * @param image the image to be painted
     */
    public ImagePainterX(BufferedImage image, HorizontalAlignment horizontal, VerticalAlignment vertical) {
        super();
        this.img = image;
    ...
    public ImagePainterX(URL url) throws IOException {
        this(ImageIO.read(url));
    }
    public ImagePainterX(URL url, HorizontalAlignment horizontal, VerticalAlignment vertical) throws IOException {
