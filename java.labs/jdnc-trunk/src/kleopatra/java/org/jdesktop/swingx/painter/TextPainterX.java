/*
 * $Id: TextPainterX.java 1193 2007-04-03 16:20:57Z kleopatra $
 *
 ...
 * @author rbair
 */
public class TextPainterX<T> extends AbstractAreaPainterX<T> {
    private String text = "";
     ...
     */
    public TextPainterX(String text) {
        this(text, null, null);
    }
     ...
     */
    public TextPainterX(String text, Font font) {
        this(text, font, null);
    }
     ...
     */
    public TextPainterX(String text, Paint paint) {
     ...
     * @param paint the paint to paint with
     */
    public TextPainterX(String text, Font font, Paint paint) {
        this.text = text;
        this.font = font;
        setFillPaint(paint);
    }
