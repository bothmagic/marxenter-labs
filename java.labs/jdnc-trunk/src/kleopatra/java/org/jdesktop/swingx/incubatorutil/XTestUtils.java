/*
 * $Id: XTestUtils.java 2542 2008-07-13 10:32:05Z kleopatra $
 *
...
public class XTestUtils {
    ...
    public static BufferedImage loadDefaultImage(String imageName) {
        return loadDefaultImage(BASE, IMAGE_DIR + imageName);
    }
    
    public static BufferedImage loadDefaultImage(Class<?> base, String imagePath) {
        try {
            return ImageIO.read(base.getResource(imagePath));
        } catch (IOException e) {
