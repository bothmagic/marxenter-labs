...
/**
 * Mostly c&p of TableRowSorter to extend BasicRowSorter for its additional functionality.
 * Limited generic scope. No other changes.
 * 
 ...
 * @since 1.6
 */
public class BasicTableRowSorter extends BasicRowSorter<TableModel, Integer> {
    /**
     ...
     */
    public BasicTableRowSorter(TableModel model) {
        setModel(model);
    }
