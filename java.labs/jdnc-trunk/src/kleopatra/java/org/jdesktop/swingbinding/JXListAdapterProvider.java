 ...
 */
public final class JXListAdapterProvider implements BeanAdapterProvider {
    ...
    public final class Adapter extends BeanAdapterBase {
        ...
        public Object getSelectedElement() {
            return JXListAdapterProvider.getSelectedElement(list);
        }
        ...
        private int getElementIndex(Object element) {
            ...
            if (model instanceof ListBindingManager) {
                return ((ListBindingManager) model).getElements().indexOf(element);
            }
        ...
        public List<Object> getSelectedElements() {
            return JXListAdapterProvider.getSelectedElements(list);
        }
    ...
    public Class<?> getAdapterClass(Class<?> type) {
        return JList.class.isAssignableFrom(type) ? 
            JXListAdapterProvider.Adapter.class :
            null;
    }
