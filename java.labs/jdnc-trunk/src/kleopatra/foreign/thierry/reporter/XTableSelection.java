...
public class XTableSelection implements Transferable, ClipboardOwner {
	
	public static void installCopyAction(final JXTable table) {
		KeyStroke copy = KeyStroke.getKeyStroke(
	      ...
	      Action copyAction = new AbstractAction("Copy") {
			...
			public void actionPerformed(ActionEvent e) {
				XTableSelection transfer = new XTableSelection(table);
     ...
     public XTableSelection(JXTable table) {
    	 this.table = table;
     }
     ...
     private String getHTMLStringSelection() {
    	return new XTableReportGenerator(table).getSelection(new HTMLReportBuilder());
     }
     ...
     private String getTextStringSelection() {
    	 return new XTableReportGenerator(table).getSelection(new TextReportBuilder());
     }
