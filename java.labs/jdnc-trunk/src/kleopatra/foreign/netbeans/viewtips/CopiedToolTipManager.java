 ...
 * @author Rich Schiavi
 */
public class CopiedToolTipManager extends MouseAdapter implements MouseMotionListener  {
...
//                if (x > 0 || y > 0) {
//                    popupFactory.setPopupType(MEDIUM_WEIGHT_POPUP);
//                } else {
//                    popupFactory.setPopupType(LIGHT_WEIGHT_POPUP);
//                }
//            } else {
//                popupFactory.setPopupType(MEDIUM_WEIGHT_POPUP);
//            }
...
//            popupFactory.setPopupType(LIGHT_WEIGHT_POPUP);
     ...
     */
    public static CopiedToolTipManager sharedInstance() {
        Object value = AppContext.getAppContext().get(TOOL_TIP_MANAGER_KEY);
        if (value instanceof CopiedToolTipManager) {
            return (CopiedToolTipManager) value;
        }
        CopiedToolTipManager manager = new CopiedToolTipManager();
        AppContext.getAppContext().put(TOOL_TIP_MANAGER_KEY, manager);
        return manager;
    }
  ...
  private int getWidthAdjust(Rectangle a, Rectangle b){
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (key == SHOW) {
                CopiedToolTipManager.sharedInstance().show(source);
            }
            else if (key == HIDE) {
                CopiedToolTipManager.sharedInstance().hide(source);
            }
        }
        ...
        public boolean isEnabled(Object sender) {
            ...
            return CopiedToolTipManager.sharedInstance().tipShowing;
        }
    }
}
