/*
 * $Id: AlternateRowHighlighter.java 761 2005-12-02 23:53:42Z rbair $
 *
...
package org.jdesktop.swingx.highlighters2;
...
public class AlternateRowHighlighter extends Highlighter {
    private final static Color  DEFAULT_ODD_ROW_COLOR = Color.white;
    private final static Color  DEFAULT_EVEN_ROW_COLOR = new Color(0xF0, 0xF0, 0xE0);

    public final static Highlighter BEIGE =
        new AlternateRowHighlighter(Color.white, new Color(245, 245, 220), null, true);

    public final static Highlighter LINE_PRINTER =
        new AlternateRowHighlighter(Color.white, new Color(0xCC, 0xCC, 0xFF), null, true);

    public final static Highlighter CLASSIC_LINE_PRINTER =
        new AlternateRowHighlighter(Color.white, new Color(0xCC, 0xFF, 0xCC), null, true);

    public final static Highlighter FLORAL_WHITE =
        new AlternateRowHighlighter(Color.white, new Color(255, 250, 240), null, true);

    public final static Highlighter QUICKSILVER =
        new AlternateRowHighlighter(Color.white, DEFAULT_EVEN_ROW_COLOR, null, true);
    
    public final static AlternateRowHighlighter GENERIC_GRAY = 
        new AlternateRowHighlighter(Color.white, new Color(229, 229, 229), null, true);

    private Color oddRowBackground = DEFAULT_ODD_ROW_COLOR;
    private Color evenRowBackground = DEFAULT_EVEN_ROW_COLOR;
    ...
    public static class UIAlternateRowHighlighter extends AlternateRowHighlighter 
       implements UIHighlighter {
        ...
        private Color getMappedColor(Color selection) {
            ...
            if (color == null) {
                color = AlternateRowHighlighter.GENERIC_GRAY.getEvenRowBackground();
            }
            return color;
        }
        /** 
