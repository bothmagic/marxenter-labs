...
import org.jdesktop.swingx.BuddySupport;
...
public abstract class TextUIWrapper<UI extends TextUI> {
	...
	public static final class DefaultWrapper extends TextUIWrapper<PromptTextUI> {
		 ...
		 * <code>textComponent</code>s UI.
		 * </p>
		 * <p>
		 * If the UI is already of type {@link PromptTextUI}, it will be
		 * returned. If <code>textComponent</code> is of type
		 * {@link JXSearchField} a new {@link SearchFieldUI} object will be
		 * returned. If <code>textComponent</code> is of type
		 * {@link JTextField} or {@link JTextArea} a {@link BuddyTextFieldUI}
		 * or {@link PromptTextAreaUI} will be returned, respectively. If the UI is of any
		 * other type, a {@link IllegalArgumentException} will bw thrown.
		 * </p>
		 * 
		 * @param textComponent
