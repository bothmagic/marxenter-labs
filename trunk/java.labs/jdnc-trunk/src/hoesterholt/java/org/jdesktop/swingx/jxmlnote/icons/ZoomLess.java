 ...
 */
public class ZoomLess implements FlamencoIconAdapter{
	/**
...
g.transform(new AffineTransform(0.4897027909755707f, 0.0f, 0.0f, 0.4897027909755707f, 6.603191375732422f, 5.434883117675781f));
// _0_0_1
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
