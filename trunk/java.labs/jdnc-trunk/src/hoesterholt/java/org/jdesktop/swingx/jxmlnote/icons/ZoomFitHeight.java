 ...
 */
public class ZoomFitHeight implements FlamencoIconAdapter {
	/**
...
shape = new Rectangle2D.Double(12.904699325561523, 8.578795433044434, 11.225320816040039, 17.412506103515625);
g.setPaint(paint);
g.fill(shape);
