...
import org.jdesktop.swingx.jxmlnote.report.Report.ReportListener;
...
public class ReportProgressBar extends JDialog {
	...
	public static ReportProgressBar runJob(Report report,Component parent,String title,Job job,XMLNotePreferences prefs) {
		ReportProgressBar bar=new ReportProgressBar(report,SwingUtilities.getWindowAncestor(parent),parent,title,job,prefs);
		bar.run();
		return bar;
	}
