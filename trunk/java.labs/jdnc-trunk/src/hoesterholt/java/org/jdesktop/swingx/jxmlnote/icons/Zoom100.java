 ...
 */
public class Zoom100  implements FlamencoIconAdapter{
	/**
...
shape = new Rectangle2D.Double(12.197592735290527, 12.025940895080566, 2.9168155193328857, 11.844038963317871);
g.setPaint(paint);
g.fill(shape);
paint = new Color(0, 0, 123, 199);
stroke = new BasicStroke(0.2f,1,1,3.8f,null,0.0f);
shape = new Rectangle2D.Double(12.197592735290527, 12.025940895080566, 2.9168155193328857, 11.844038963317871);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
// _0_0_2
paint = new Color(0, 24, 146, 255);
shape = new Rectangle2D.Double(17.324115753173828, 18.478290557861328, 2.4748737812042236, 2.6516504287719727);
g.setPaint(paint);
g.fill(shape);
paint = new Color(0, 0, 123, 199);
stroke = new BasicStroke(0.2f,1,1,3.8f,null,0.0f);
...
// _0_0_3
paint = new Color(0, 24, 146, 255);
shape = new Rectangle2D.Double(22.052894592285156, 12.025940895080566, 2.9168155193328857, 11.844038963317871);
g.setPaint(paint);
g.fill(shape);
paint = new Color(0, 0, 123, 199);
stroke = new BasicStroke(0.2f,1,1,3.8f,null,0.0f);
...
// _0_0_4
paint = new Color(0, 24, 146, 255);
shape = new Rectangle2D.Double(17.324115753173828, 14.058873176574707, 2.4748737812042236, 2.6516504287719727);
g.setPaint(paint);
g.fill(shape);
paint = new Color(0, 0, 123, 199);
stroke = new BasicStroke(0.2f,1,1,3.8f,null,0.0f);
