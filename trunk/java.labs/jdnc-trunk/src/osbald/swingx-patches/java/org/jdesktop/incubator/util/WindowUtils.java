/*
 * $Id: WindowUtils.java 2578 2008-07-29 23:16:17Z osbald $
 *
...
/*
   ...
   19-Nov-2007 RJO: Added getFirstDescendantOfClass() as a counterpart to SwingUtilities getAncestorOfClass().
...
public final class WindowUtils {
    ...
    /**
     * Hide the constructor - don't want anybody creating an instance of this
     */
    private WindowUtils() {
    }
    ...
    /**
     * Convenience method for searching below <code>component</code> in the
     * component hierarchy and returns the first object of class <code>clazz</code> it
     * finds. Can return {@code null}, if a class <code>c</code> cannot be found.
     *
     * @param target Class of the component we are looking for
     * @param event  event whose source is our starting location
     * @return first component of the given type, or null if nothing found
     */
