/*
 * $Id: JXComponent.java 2578 2008-07-29 23:16:17Z osbald $
 *
 ...
 *
 * <p> SwingX Painters similar to both {@link javax.swing.border.Border borders} and {@link javax.swing.Icon icons} in
 * that they simply define a set of painting rules to be rendered to a Graphics object when needed.
 *
 ...
 * applied to these children. To add effects to all child components see {@link JXEffectPanel}. As with the background
 * painter the foreground painter is invoked by the XComponentUI instance assigned to the component.
 *
 *
