...
public final class UIFactory {
    ...
    public static void registerFactoryForTextUIs() {
        UIManager.put("ClassLoader", UIFactory.class.getClassLoader());
        UIManager.put("TextAreaUI", UIFactory.class.getName());
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        if (c instanceof JTextComponent) {
            ...
            return UIManager.getLookAndFeelDefaults().getUI(c);
        }
        throw new IllegalStateException("UIFactory only supports JTextComponent");
    }
