/*
 * $Id: Highlighter.java 1049 2007-01-26 11:09:04Z ovisvana $
 *
...
/*
        System.out.println(" hiliter row = " + adapter.row);
        System.out.println(" hiliter col = " + adapter.column);
        System.out.println(" hiliter bg = " + color);
*/        
        if (color != null) 
    ...
    /*    System.out.println(" in computeSelectedBackground bg = " +  getSelectedBackground()); */ 
