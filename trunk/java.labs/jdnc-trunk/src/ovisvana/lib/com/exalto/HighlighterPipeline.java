/*
 * $Id: HighlighterPipeline.java 1049 2007-01-26 11:09:04Z ovisvana $
 *
...
//        highlighters.addAll(copy);
    ...
    */
    ...
    public void updateUI() {
    	...
    	while(iter.hasNext()) {
    		Highlighter highlighter = (Highlighter) iter.next();
  ...
  //end
    ...
    public Component apply(Component stamp, ComponentAdapter adapter) {
        ...
        */ 
        ...
        for (Iterator iter = highlighters.iterator(); iter.hasNext();) {
