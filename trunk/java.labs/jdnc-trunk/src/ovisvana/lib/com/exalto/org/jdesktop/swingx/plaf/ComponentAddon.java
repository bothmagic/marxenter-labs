/*
 * $Id: ComponentAddon.java 1050 2007-01-26 11:11:44Z ovisvana $
 *
...
public interface ComponentAddon {
   ...
   */
   ...
   //OV void initialize(LookAndFeelAddons addon);
  void initialize(Addons addon);
   ...
   * @param addon
   */
//OV   void uninitialize(LookAndFeelAddons addon);
  void uninitialize(Addons addon);
