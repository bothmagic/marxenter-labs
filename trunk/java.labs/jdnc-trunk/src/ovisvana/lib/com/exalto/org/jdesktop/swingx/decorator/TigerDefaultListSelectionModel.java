...
public class TigerDefaultListSelectionModel implements ListSelectionModel, Cloneable, Serializable
{
    ...
    */
    ...
    public ListSelectionListener[] getListeners(Class listenerType) { 
    	return (ListSelectionListener[]) listenerList.getListeners(listenerType); 
    }
    ...
    */
	...
	TigerDefaultListSelectionModel clone = (TigerDefaultListSelectionModel)super.clone();
