/*
 * $Id: PatternFilter.java 1050 2007-01-26 11:11:44Z ovisvana $
 *
...
public class PatternFilter extends Filter implements PatternMatcher {
    ...
    protected void filter() {
        ...
        for (int i = 0; i < getInputSize(); i++) {
        	System.out.println(" fromprev i = " + fromPrevious[i]);
        	if(i < toPrevious.size())
        		System.out.println(" toprev i = " + toPrevious.get(i));
    ...
    public boolean test(int row) {
        ...
        System.out.println(" @@@@@@@@@@@@@@@@patternn matycher inp value =@@@@@@@@@@@@@@@@@@@@" + value);
        ...
        if (value == null) {
            ...
            System.out.println(" @@@@@@@@@@@@@@@@patternn matyches result  =@@@@@@@@@@@@@@@@@@@@" + matches);
    ...
    protected int mapTowardModel(int row) {
    	...
    	System.out.println(" @@@@@@@@@@@@@@@@ MTM row in =@@@@@@@@@@@@@@@@@@@@" + row);
    	System.out.println(" @@@@@@@@@@@@@@@@ MTM row out =@@@@@@@@@@@@@@@@@@@@" + toPrevious.get(row));
