...
/**
 * UI for the decimal field
 * @author Ryan Cuprak
 */
public class DecimalFieldUI extends MetalTextFieldUI {
    ...
    public View create(Element element) {
        return new DecimalFieldView((JXDecimalField)getComponent(),element);
    }
