 ...
 * Is Factory for custom PersistanceDelegates.<p>
 * NOTE: this is targeted at jdk6 (since Aug.200 ) - anybody interested in 
 * a version targeted to jdk5 should checkout a previous version from svn, 
 * revision #1691.
 * <p> 
 * NOTE: as of 20.Oct. 2009, this is changed to use bsaf-1.9-M1 - which has
 * refactored session storage as compared to earlier versions.
 * 
 */
public class XProperties {
    ...
    /**
     * As of bsaf-1.9M1 this implements session.PropertySupport instead of 
