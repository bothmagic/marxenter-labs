 ...
 */
public class SingleListCCExample {
    ...
    JComponent getContent() {
        ...
        String description = "This example implements a ColumnControlButton (" +
                        ...
                        "with a custom popup. The popup is a dialog with one list which " +
                        "contains all columns. Toggling visibility is achieved " +
                        "by double-clicking a list item or pressing space. <br/> ";
        header.setDescription(description);
        panel.add(header, BorderLayout.NORTH);
        JXTable table = createTable();
        table.setColumnControlVisible(true);
        table.setColumnControl(new SingleListColumnControlButton(table,
...
//            " <li> link: <a href=\"http://forums.java.net/jive/thread.jspa?threadID=7417\">relevant requirement discussion </a> <br/>" +
            " <li> technique: custom list renderer to show checkbox with text  <br/> " +
            " <li> technique: toggle checkbox by custom action  <br/> " +
...
//                painter.setLocation(new Point2D.Double(0.2d, 0.3d));
    ...
    public static void main(String[] args) {
        ...
        final JXFrame frame = new JXFrame(
                ...
                true);
        frame.add(new SingleListCCExample().getContent());
