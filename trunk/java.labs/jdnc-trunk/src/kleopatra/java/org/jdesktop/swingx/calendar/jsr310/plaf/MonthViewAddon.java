...
public class MonthViewAddon extends AbstractComponentAddon {
    ...
    protected void addBasicDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
        ...
        defaults.add(JXMonthView.uiClassID, "org.jdesktop.swingx.calendar.jsr310.plaf.BasicMonthViewUI");
        ...
        defaults.add("JXMonthView.monthDownFileName",
                LookAndFeel.makeIcon(MonthViewAddon.class, "resources/month-down.png"));
        defaults.add("JXMonthView.monthUpFileName",
                LookAndFeel.makeIcon(MonthViewAddon.class, "resources/month-up.png"));
