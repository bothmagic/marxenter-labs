...
{   
     ...
     * Report.  It is modified to allow both vertical and horizounal modes.
     ...
     * 
     * ADDITIONAL NOTE (Ingo Friese): bugfixes, support of java generics
     */
    ...
    private void offset(int dxOrDy) {
        setLowValue(getLowValue()+dxOrDy);
        setHighValue(getHighValue()+dxOrDy);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        final boolean v = (orientation == VERTICAL);
        final boolean d = (kc == KeyEvent.VK_DOWN);
        final boolean u = (kc == KeyEvent.VK_UP);
