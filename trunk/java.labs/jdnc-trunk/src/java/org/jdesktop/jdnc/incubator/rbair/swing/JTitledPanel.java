/*
 * $Id: JTitledPanel.java 148 2004-10-29 20:43:46Z rbair $
 *
...
import org.jdesktop.jdnc.incubator.rbair.util.UIManagerUtils;
 ...
 * 	<li>JTitledPanel.title.darkBackground</li>
 * 	<li>JTitledPanel.title.lightBackground</li>
...
public class JTitledPanel extends JPanel {
	 ...
	 * @param content
	 */
	public JTitledPanel(String title, Container content) {
		this(title);
