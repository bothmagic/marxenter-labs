...
/*
 * See http://forum.java.sun.com/thread.jspa?threadID=337070&start=15&tstart=0
 *
 * Thanks to fast_
 *
 * Modified to include a nicer default icon set and to support icon and tooltip for the tab
 */
...
public class CloseableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {
    ...
    private void init(int horizontalTextPosition) {
        ...
        setCloseIcons(
            new ImageIcon(myClass.getResource("/org/jdesktop/jdnc/incubator/rlopes/closeabletabbedpane/resources/normal.gif")), 
            new ImageIcon(myClass.getResource("/org/jdesktop/jdnc/incubator/rlopes/closeabletabbedpane/resources/over.gif")), 
            new ImageIcon(myClass.getResource("/org/jdesktop/jdnc/incubator/rlopes/closeabletabbedpane/resources/close.gif"))
        );
