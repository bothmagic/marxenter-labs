/*
 * $Id: AbstractSearchable.java 2230 2008-02-13 05:24:09Z headw01 $
 *
 ...
 */
public abstract class AbstractSearchable<T extends SearchAssistant> implements Searchable<T> {
    /**
    ...
    /** SearchAssistant for this class */
    private T searchAssistant = null;
    
    
    @Override
    public T getSearchAssistant() {
        if (null == searchAssistant) {
            searchAssistant = createSearchAssistant();
        }
        return searchAssistant;
    }
    
    /**
     * Create a custom default instance of a SearchAssistant.<br>
     * This method may return <code>null</code> if there isn't a default
     * implementation.
     * @return
     */
    protected T createSearchAssistant() {
        return null;
    }

    @Override
    public void setSearchAssistant(T searchAssistant) {
