/*
 * $Id: PatternFilter.java 2278 2008-02-19 17:51:16Z headw01 $
 *
...
public class PatternFilter extends Filter implements PatternMatcher {
    ...
    public boolean test(int row) {
        ...
        // We are the currently running Filter, so don't mapToModel here.
        return null != findMatchAt(pattern, row, getColumnIndex(), false);
    }
