 ...
 * @author Arash Nikkar
 */
public class MetalMultiSliderUI extends BasicMultiSliderUI {
    ...
    */
    ...
    public static BasicMultiSliderUI createUI(JComponent c)    {
        return new MetalMultiSliderUI((JXMultiSlider)c);
    }

    public MetalMultiSliderUI(JXMultiSlider b) {
        super(b);
    }
    ...
    protected class MetalPropertyListener extends BasicMultiSliderUI.PropertyChangeHandler {
