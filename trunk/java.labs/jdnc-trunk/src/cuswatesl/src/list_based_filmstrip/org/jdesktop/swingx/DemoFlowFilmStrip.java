...
public class DemoFlowFilmStrip {

	public DemoFlowFilmStrip() {
		...
		final FlowFilmStrip fs = new FlowFilmStrip();
		...
		feelMenu.add(new JMenuItem(new AbstractAction("Horizontal flow"){
			public void actionPerformed(ActionEvent e) {
				fs.setLayoutOrientation(JList.HORIZONTAL_WRAP);
			}
		}));
		
		feelMenu.add(new JMenuItem(new AbstractAction("Vertical flow"){
			public void actionPerformed(ActionEvent e) {
				fs.setLayoutOrientation(JList.VERTICAL_WRAP);
			}
		}));
