...
public interface ImageSource {
	 ...
	 *  
	 * @param name the name bound to the scaled version of the image
	 ...
	 */
	void createCachedImage(String name, int maxWidth, int maxHeight, ImageScaler scaler, Runnable callBack);
	 ...
	 * @see ImageScaler#scaleImage(BufferedImage, float, float, boolean)
	 */
	void createCachedImage(String name, int maxWidth, int maxHeight, ImageScaler scaler, Runnable callBack, boolean cacheVolatile);
	 ...
	 * @return
	 */
	BufferedImage getCachedImage(String name);
	 ...
	 * @param image
	 */
	void cacheImage(String name, BufferedImage image);
	 ...
	 * //TODO this should also be named.
	 */
	void cancelTask();
