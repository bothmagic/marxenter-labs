...
public class TestFilmStrip {

	public TestFilmStrip() {
		...
		fs.setPreviewDimension(new Dimension(180, 140));
		...
		previewMenu.add(new JMenuItem(new AbstractAction("120 * 120"){
			public void actionPerformed(ActionEvent e) {
				fs.setPreviewDimension(new Dimension(120, 120));
			}
		}));
		
		previewMenu.add(new JMenuItem(new AbstractAction("90 * 90"){
			public void actionPerformed(ActionEvent e) {
				fs.setPreviewDimension(new Dimension(90, 90));
			}
		}));
		
		previewMenu.add(new JMenuItem(new AbstractAction("80 * 80"){
			public void actionPerformed(ActionEvent e) {
				fs.setPreviewDimension(new Dimension(80, 80));
			}
		}));
		...
		previewMenu.add(new JMenuItem(new AbstractAction("140 * 180"){
			public void actionPerformed(ActionEvent e) {
				fs.setPreviewDimension(new Dimension(140, 180));
			}
		}));
