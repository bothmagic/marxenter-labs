 ...
 * @author Nick
 */
public interface FilmStripCellRenderer {
	
    /**
     * Return a component that has been configured to display the specified
     * image. That component's <code>paint</code> method is then called to
     * "render" the cell. It usually works better to override 
