/*
 * $Id: CompoundHighlighter.java 761 2005-12-02 23:53:42Z rbair $
 *
...
import org.jdesktop.swingx.highlighters2.Highlighter.UIHighlighter;
 ...
 * 
 */
public class CompoundHighlighter extends Highlighter implements UIHighlighter {
    ...
    */
    ...
    public Component highlight(Component renderer, ComponentAdapter adapter) {
        ...
        /** @todo optimize the following bug fix */
            renderer = nullHighlighter.highlight(renderer, adapter); 
        }
        for (Iterator<Highlighter> iter = highlighters.iterator(); iter.hasNext();) {
            renderer = iter.next().highlight(renderer, adapter);
