 ...
 * @author Ramesh Gupta
 */
public abstract class AbstractTreeTableModel_REDEN implements TreeTableModel_REDEN {
    /**
     ...
     */
    public AbstractTreeTableModel_REDEN() {
        this(null);
    }
     ...
     */
    public AbstractTreeTableModel_REDEN(Object root) {
        this.root = root;
    }
