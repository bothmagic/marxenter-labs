 ...
 ***************************************************************************/
#ifndef DECLARATIVEBUTTON_H
#define DECLARATIVEBUTTON_H

#include <QStyleOptionButton>
#include "declarativewidget.h"

class DeclarativeButton : public DeclarativeWidget
{
	Q_OBJECT
	Q_PROPERTY(bool menu READ hasMenu WRITE setMenu NOTIFY menuChanged)
	Q_PROPERTY(bool hovered READ hovered WRITE setHovered NOTIFY hoveredChanged)
	Q_PROPERTY(bool pressed READ pressed WRITE setPressed NOTIFY pressedChanged)

public:
	explicit DeclarativeButton(QDeclarativeItem *parent = 0);
	bool hasMenu() const;
...
signals:
	...
	void menuChanged(bool on);
	void pressedChanged(bool on);
};

#endif // DECLARATIVEBUTTON_H
