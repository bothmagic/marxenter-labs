/****************************************************************************
** Meta object code from reading C++ file 'qtreemodeladaptor.h'
**
** Created: Thu 7. Jul 08:18:12 2011
...
#error "The header file 'qtreemodeladaptor.h' doesn't include <QObject>."
...
static const uint qt_meta_data_QtTreeModelAdaptor[] = {
...
static const char qt_meta_stringdata_QtTreeModelAdaptor[] = {
    "QtTreeModelAdaptor\0\0_q_modelDestroyed()\0"
...
const QMetaObject QtTreeModelAdaptor::staticMetaObject = {
    { &QtTreeModelInterface<QPersistentModelIndex>::staticMetaObject, qt_meta_stringdata_QtTreeModelAdaptor,
      qt_meta_data_QtTreeModelAdaptor, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QtTreeModelAdaptor::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *QtTreeModelAdaptor::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *QtTreeModelAdaptor::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtTreeModelAdaptor))
        return static_cast<void*>(const_cast< QtTreeModelAdaptor*>(this));
    return QtTreeModelInterface<QPersistentModelIndex>::qt_metacast(_clname);
}

int QtTreeModelAdaptor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QtTreeModelInterface<QPersistentModelIndex>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
