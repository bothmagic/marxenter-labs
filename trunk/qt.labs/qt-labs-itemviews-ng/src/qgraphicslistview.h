...
public:
    ...
    void setModel(QtListModelInderface *model);
    void setSelectionManager(QtListSelectionManager *selectionManager);
    void setController(QtListController *controller);
